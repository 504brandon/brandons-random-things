...
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_3272_this_onKeyDown,"openfl.text.TextField","this_onKeyDown",0xebbe0505,"openfl.text.TextField.this_onKeyDown","openfl/text/TextField.hx",3272,0xccf02094)
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_3283_this_onMouseDown,"openfl.text.TextField","this_onMouseDown",0xfda1ed8b,"openfl.text.TextField.this_onMouseDown","openfl/text/TextField.hx",3283,0xccf02094)
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_3310_this_onMouseWheel,"openfl.text.TextField","this_onMouseWheel",0xdbfcc352,"openfl.text.TextField.this_onMouseWheel","openfl/text/TextField.hx",3310,0xccf02094)
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_3318_this_onDoubleClick,"openfl.text.TextField","this_onDoubleClick",0xbfe820db,"openfl.text.TextField.this_onDoubleClick","openfl/text/TextField.hx",3318,0xccf02094)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_3368_window_onKeyDown,"openfl.text.TextField","window_onKeyDown",0x61330e17,"openfl.text.TextField.window_onKeyDown","openfl/text/TextField.hx",3368,0xccf02094)
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_3594_window_onTextInput,"openfl.text.TextField","window_onTextInput",0xe9818213,"openfl.text.TextField.window_onTextInput","openfl/text/TextField.hx",3594,0xccf02094)
...
HXLINE(3244)		bool _hx_tmp;
HXDLIN(3244)		if (::hx::IsNotNull( event->relatedObject )) {
HXLINE(3244)			_hx_tmp = !(::Std_obj::isOfType(event->relatedObject,::hx::ClassOf< ::openfl::text::TextField >()));
            		}
            		else {
HXLINE(3244)			_hx_tmp = true;
            		}
HXDLIN(3244)		if (_hx_tmp) {
HXLINE(3246)			this->_hx___stopTextInput();
            		}
            		else {
HXLINE(3250)			if (::hx::IsNotNull( this->stage )) {
HXLINE(3253)				this->stage->window->onTextInput->remove(this->window_onTextInput_dyn());
HXLINE(3254)				this->stage->window->onKeyDown->remove(this->window_onKeyDown_dyn());
            			}
HXLINE(3258)			this->_hx___inputEnabled = false;
            		}
HXLINE(3261)		if ((this->_hx___selectionIndex != this->_hx___caretIndex)) {
HXLINE(3263)			this->_hx___selectionIndex = this->_hx___caretIndex;
HXLINE(3264)			this->_hx___dirty = true;
HXLINE(3265)			if (!(this->_hx___renderDirty)) {
HXLINE(3265)				this->_hx___renderDirty = true;
HXDLIN(3265)				this->_hx___setParentRenderDirty();
            			}
            		}
            	}
...
void TextField_obj::this_onKeyDown( ::openfl::events::KeyboardEvent event){
            	HX_STACKFRAME(&_hx_pos_d001dbc361c2c159_3272_this_onKeyDown)
HXDLIN(3272)		bool _hx_tmp;
HXDLIN(3272)		bool _hx_tmp1;
HXDLIN(3272)		bool _hx_tmp2;
HXDLIN(3272)		if (this->get_selectable()) {
HXDLIN(3272)			_hx_tmp2 = ::hx::IsNotEq( this->get_type(),1 );
            		}
            		else {
HXDLIN(3272)			_hx_tmp2 = false;
            		}
HXDLIN(3272)		if (_hx_tmp2) {
HXDLIN(3272)			_hx_tmp1 = (event->keyCode == 67);
            		}
            		else {
HXDLIN(3272)			_hx_tmp1 = false;
            		}
HXDLIN(3272)		if (_hx_tmp1) {
HXDLIN(3272)			if (!(event->commandKey)) {
HXDLIN(3272)				_hx_tmp = event->ctrlKey;
            			}
            			else {
HXDLIN(3272)				_hx_tmp = true;
            			}
            		}
            		else {
HXDLIN(3272)			_hx_tmp = false;
            		}
HXDLIN(3272)		if (_hx_tmp) {
HXLINE(3274)			if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3276)				::lime::_hx_system::Clipboard_obj::set_text(this->_hx___text.substring(this->_hx___caretIndex,this->_hx___selectionIndex));
            			}
            		}
            	}
...
void TextField_obj::this_onMouseDown( ::openfl::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_d001dbc361c2c159_3283_this_onMouseDown)
HXLINE(3284)		bool _hx_tmp;
HXDLIN(3284)		if (!(this->get_selectable())) {
HXLINE(3284)			_hx_tmp = ::hx::IsNotEq( this->get_type(),1 );
            		}
            		else {
...
HXLINE(3288)		Float _hx_tmp1 = this->get_mouseX();
HXDLIN(3288)		Float _hx_tmp2 = (_hx_tmp1 + this->get_scrollH());
HXDLIN(3288)		this->_hx___caretIndex = this->_hx___getPosition(_hx_tmp2,this->get_mouseY());
HXLINE(3289)		this->_hx___selectionIndex = this->_hx___caretIndex;
HXLINE(3292)		{
HXLINE(3293)			this->_hx___dirty = true;
HXLINE(3294)			if (!(this->_hx___renderDirty)) {
HXLINE(3294)				this->_hx___renderDirty = true;
HXDLIN(3294)				this->_hx___setParentRenderDirty();
            			}
            		}
HXLINE(3299)		if (::hx::IsNull( this->stage )) {
HXLINE(3299)			return;
            		}
HXLINE(3302)		this->stage->addEventListener(HX_("enterFrame",f5,03,50,02),this->this_onEnterFrame_dyn(),null(),null(),null());
HXLINE(3304)		this->stage->addEventListener(HX_("mouseMove",d6,9b,b5,f4),this->stage_onMouseMove_dyn(),null(),null(),null());
HXLINE(3305)		this->stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->stage_onMouseUp_dyn(),null(),null(),null());
            	}
...
void TextField_obj::this_onMouseWheel( ::openfl::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_d001dbc361c2c159_3310_this_onMouseWheel)
HXDLIN(3310)		if (this->get_mouseWheelEnabled()) {
HXLINE(3312)			int _hx_tmp = this->get_scrollV();
HXDLIN(3312)			int _hx_tmp1 = (_hx_tmp - event->delta);
HXDLIN(3312)			this->set_scrollV(::Std_obj::_hx_int(::Math_obj::min(( (Float)(_hx_tmp1) ),( (Float)(this->get_maxScrollV()) ))));
            		}
            	}
...
void TextField_obj::this_onDoubleClick( ::openfl::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_d001dbc361c2c159_3318_this_onDoubleClick)
HXDLIN(3318)		if (this->get_selectable()) {
HXLINE(3320)			this->_hx___updateLayout();
HXLINE(3322)			::Array< ::String > delimiters = ::Array_obj< ::String >::fromData( _hx_array_data_efd5a8ca_158,13);
HXLINE(3324)			::String txtStr = this->_hx___text;
HXLINE(3325)			int leftPos = -1;
HXLINE(3326)			int rightPos = txtStr.length;
HXLINE(3327)			int pos = 0;
HXLINE(3328)			int startPos = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(this->_hx___caretIndex) ),( (Float)(1) )));
HXLINE(3329)			bool _hx_tmp;
HXDLIN(3329)			bool _hx_tmp1;
HXDLIN(3329)			if ((txtStr.length > 0)) {
HXLINE(3329)				_hx_tmp1 = (this->_hx___caretIndex >= 0);
            			}
            			else {
HXLINE(3329)				_hx_tmp1 = false;
            			}
HXDLIN(3329)			if (_hx_tmp1) {
HXLINE(3329)				_hx_tmp = (rightPos >= this->_hx___caretIndex);
            			}
            			else {
...
HXLINE(3331)				{
HXLINE(3331)					int _g = 0;
HXDLIN(3331)					while((_g < delimiters->length)){
HXLINE(3331)						::String c = delimiters->__get(_g);
HXDLIN(3331)						_g = (_g + 1);
HXLINE(3333)						pos = txtStr.lastIndexOf(c,(startPos - 1));
HXLINE(3334)						if ((pos > leftPos)) {
HXLINE(3334)							leftPos = (pos + 1);
            						}
HXLINE(3336)						pos = txtStr.indexOf(c,startPos);
HXLINE(3337)						bool _hx_tmp;
HXDLIN(3337)						if ((pos < rightPos)) {
HXLINE(3337)							_hx_tmp = (pos != -1);
            						}
            						else {
HXLINE(3337)							_hx_tmp = false;
            						}
HXDLIN(3337)						if (_hx_tmp) {
HXLINE(3337)							rightPos = pos;
            						}
            					}
            				}
HXLINE(3340)				if ((leftPos != rightPos)) {
HXLINE(3342)					this->setSelection(leftPos,rightPos);
HXLINE(3344)					bool setDirty = true;
HXLINE(3355)					if (setDirty) {
HXLINE(3357)						this->_hx___dirty = true;
HXLINE(3358)						if (!(this->_hx___renderDirty)) {
HXLINE(3358)							this->_hx___renderDirty = true;
HXDLIN(3358)							this->_hx___setParentRenderDirty();
            						}
            					}
            				}
            			}
...
void TextField_obj::window_onKeyDown(int key,int modifier){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_3368_window_onKeyDown)
HXDLIN(3368)		switch((int)(key)){
            			case (int)8: {
HXLINE(3391)				bool _hx_tmp;
HXDLIN(3391)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3391)					_hx_tmp = (this->_hx___caretIndex > 0);
            				}
            				else {
HXLINE(3391)					_hx_tmp = false;
            				}
HXDLIN(3391)				if (_hx_tmp) {
HXLINE(3393)					this->_hx___selectionIndex = (this->_hx___caretIndex - 1);
            				}
HXLINE(3396)				if ((this->_hx___selectionIndex != this->_hx___caretIndex)) {
HXLINE(3398)					this->replaceSelectedText(HX_("",00,00,00,00));
HXLINE(3399)					this->_hx___selectionIndex = this->_hx___caretIndex;
HXLINE(3401)					this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            				}
            				else {
HXLINE(3405)					this->_hx___stopCursorTimer();
HXLINE(3406)					this->_hx___startCursorTimer();
            				}
            			}
            			break;
            			case (int)97: {
HXLINE(3582)				if (this->get_selectable()) {
HXLINE(3583)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3585)						this->setSelection(0,this->_hx___text.length);
            					}
            				}
            			}
            			break;
            			case (int)99: {
HXLINE(3532)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3534)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3536)						::lime::_hx_system::Clipboard_obj::set_text(this->_hx___text.substring(this->_hx___caretIndex,this->_hx___selectionIndex));
            					}
            				}
            			}
            			break;
            			case (int)118: {
HXLINE(3558)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3560)					if (::hx::IsNotNull( ::lime::_hx_system::Clipboard_obj::get_text() )) {
HXLINE(3562)						 ::openfl::events::TextEvent te =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,::lime::_hx_system::Clipboard_obj::get_text());
HXLINE(3564)						this->dispatchEvent(te);
HXLINE(3566)						if (!(te->isDefaultPrevented())) {
HXLINE(3568)							this->_hx___replaceSelectedText(::lime::_hx_system::Clipboard_obj::get_text(),true);
HXLINE(3570)							this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            						}
            					}
            				}
            				else {
HXLINE(3577)					::Dynamic this1 = this->_hx___textEngine->textFormatRanges;
HXDLIN(3577)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            				}
            			}
            			break;
            			case (int)120: {
HXLINE(3543)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3545)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
...
HXLINE(3549)						this->replaceSelectedText(HX_("",00,00,00,00));
HXLINE(3550)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            					}
            				}
            			}
            			break;
...
HXDLIN(3410)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3410)					_hx_tmp = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3410)					_hx_tmp = false;
            				}
HXDLIN(3410)				if (_hx_tmp) {
HXLINE(3412)					this->_hx___selectionIndex = (this->_hx___caretIndex + 1);
            				}
HXLINE(3415)				if ((this->_hx___selectionIndex != this->_hx___caretIndex)) {
HXLINE(3417)					this->replaceSelectedText(HX_("",00,00,00,00));
HXLINE(3418)					this->_hx___selectionIndex = this->_hx___caretIndex;
HXLINE(3420)					this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            				}
            				else {
HXLINE(3424)					this->_hx___stopCursorTimer();
HXLINE(3425)					this->_hx___startCursorTimer();
            				}
            			}
            			break;
            			case (int)1073741898: {
HXLINE(3496)				if (this->get_selectable()) {
HXLINE(3497)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3499)						this->_hx___caretIndex = 0;
            					}
            					else {
HXLINE(3503)						this->_hx___caretBeginningOfLine();
            					}
HXLINE(3506)					if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier))) {
HXLINE(3508)						this->_hx___selectionIndex = this->_hx___caretIndex;
            					}
HXLINE(3511)					this->setSelection(this->_hx___selectionIndex,this->_hx___caretIndex);
            				}
            			}
            			break;
            			case (int)1073741901: {
HXLINE(3513)				if (this->get_selectable()) {
HXLINE(3514)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3516)						this->_hx___caretIndex = this->_hx___text.length;
            					}
            					else {
HXLINE(3520)						this->_hx___caretEndOfLine();
            					}
HXLINE(3523)					if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier))) {
HXLINE(3525)						this->_hx___selectionIndex = this->_hx___caretIndex;
            					}
HXLINE(3528)					this->setSelection(this->_hx___selectionIndex,this->_hx___caretIndex);
            				}
            			}
            			break;
            			case (int)1073741903: {
HXLINE(3445)				if (this->get_selectable()) {
HXLINE(3446)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3448)						this->_hx___caretBeginningOfNextLine();
            					}
            					else {
HXLINE(3452)						this->_hx___caretNextCharacter();
            					}
HXLINE(3455)					if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier))) {
HXLINE(3457)						this->_hx___selectionIndex = this->_hx___caretIndex;
            					}
HXLINE(3460)					this->setSelection(this->_hx___selectionIndex,this->_hx___caretIndex);
            				}
            			}
            			break;
            			case (int)1073741904: {
HXLINE(3428)				if (this->get_selectable()) {
HXLINE(3429)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3431)						this->_hx___caretBeginningOfPreviousLine();
            					}
            					else {
HXLINE(3435)						this->_hx___caretPreviousCharacter();
            					}
HXLINE(3438)					if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier))) {
HXLINE(3440)						this->_hx___selectionIndex = this->_hx___caretIndex;
            					}
HXLINE(3443)					this->setSelection(this->_hx___selectionIndex,this->_hx___caretIndex);
            				}
            			}
            			break;
            			case (int)1073741905: {
HXLINE(3462)				if (this->get_selectable()) {
HXLINE(3463)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3465)						this->_hx___caretIndex = this->_hx___text.length;
            					}
            					else {
HXLINE(3469)						this->_hx___caretNextLine();
            					}
HXLINE(3472)					if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier))) {
HXLINE(3474)						this->_hx___selectionIndex = this->_hx___caretIndex;
            					}
HXLINE(3477)					this->setSelection(this->_hx___selectionIndex,this->_hx___caretIndex);
            				}
            			}
            			break;
            			case (int)1073741906: {
HXLINE(3479)				if (this->get_selectable()) {
HXLINE(3480)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3482)						this->_hx___caretIndex = 0;
            					}
            					else {
HXLINE(3486)						this->_hx___caretPreviousLine();
            					}
HXLINE(3489)					if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier))) {
HXLINE(3491)						this->_hx___selectionIndex = this->_hx___caretIndex;
            					}
HXLINE(3494)					this->setSelection(this->_hx___selectionIndex,this->_hx___caretIndex);
            				}
            			}
            			break;
            			case (int)13: case (int)1073741912: {
HXLINE(3371)				if (this->_hx___textEngine->multiline) {
HXLINE(3373)					 ::openfl::events::TextEvent te =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
HXLINE(3375)					this->dispatchEvent(te);
HXLINE(3377)					if (!(te->isDefaultPrevented())) {
HXLINE(3379)						this->_hx___replaceSelectedText(HX_("\n",0a,00,00,00),true);
HXLINE(3381)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            					}
            				}
            				else {
HXLINE(3386)					this->_hx___stopCursorTimer();
HXLINE(3387)					this->_hx___startCursorTimer();
            				}
            			}
            			break;
            			default:{
...
void TextField_obj::window_onTextInput(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_3594_window_onTextInput)
HXLINE(3595)		this->_hx___replaceSelectedText(value,true);
HXLINE(3598)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            	}
