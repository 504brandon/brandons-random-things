...
HX_LOCAL_STACK_FRAME(_hx_pos_043516e11ce5c7d5_1963_set___dirty,"openfl.display.Graphics","set___dirty",0x3f74a55c,"openfl.display.Graphics.set___dirty","openfl/display/Graphics.hx",1963,0x8d299ce7)
...
HXLINE(1842)		Float scaleX = ((Float)1.0);
HXDLIN(1842)		Float scaleY = ((Float)1.0);
HXLINE(1844)		if (::hx::IsNotNull( parentTransform )) {
HXLINE(1846)			if ((parentTransform->b == 0)) {
HXLINE(1848)				scaleX = ::Math_obj::abs(parentTransform->a);
            			}
            			else {
HXLINE(1852)				scaleX = ::Math_obj::sqrt(((parentTransform->a * parentTransform->a) + (parentTransform->b * parentTransform->b)));
            			}
HXLINE(1855)			if ((parentTransform->c == 0)) {
HXLINE(1857)				scaleY = ::Math_obj::abs(parentTransform->d);
            			}
            			else {
HXLINE(1861)				scaleY = ::Math_obj::sqrt(((parentTransform->c * parentTransform->c) + (parentTransform->d * parentTransform->d)));
            			}
            		}
            		else {
HXLINE(1866)			return;
            		}
HXLINE(1869)		if (::hx::IsNotNull( displayMatrix )) {
HXLINE(1871)			if ((displayMatrix->b == 0)) {
HXLINE(1873)				scaleX = (scaleX * displayMatrix->a);
            			}
            			else {
HXLINE(1877)				scaleX = (scaleX * ::Math_obj::sqrt(((displayMatrix->a * displayMatrix->a) + (displayMatrix->b * displayMatrix->b))));
            			}
HXLINE(1880)			if ((displayMatrix->c == 0)) {
HXLINE(1882)				scaleY = (scaleY * displayMatrix->d);
            			}
            			else {
HXLINE(1886)				scaleY = (scaleY * ::Math_obj::sqrt(((displayMatrix->c * displayMatrix->c) + (displayMatrix->d * displayMatrix->d))));
            			}
            		}
HXLINE(1895)		Float width = (this->_hx___bounds->width * scaleX);
HXLINE(1896)		Float height = (this->_hx___bounds->height * scaleY);
HXLINE(1898)		bool _hx_tmp2;
HXDLIN(1898)		if (!((width < 1))) {
HXLINE(1898)			_hx_tmp2 = (height < 1);
            		}
            		else {
HXLINE(1898)			_hx_tmp2 = true;
            		}
HXDLIN(1898)		if (_hx_tmp2) {
HXLINE(1900)			bool _hx_tmp;
HXDLIN(1900)			if ((this->_hx___width < 1)) {
HXLINE(1900)				_hx_tmp = (this->_hx___height >= 1);
            			}
            			else {
HXLINE(1900)				_hx_tmp = true;
            			}
HXDLIN(1900)			if (_hx_tmp) {
HXLINE(1900)				this->set___dirty(true);
            			}
HXLINE(1901)			this->_hx___width = 0;
HXLINE(1902)			this->_hx___height = 0;
HXLINE(1903)			return;
            		}
HXLINE(1906)		bool _hx_tmp3;
HXDLIN(1906)		if (::hx::IsNotNull( ::openfl::display::Graphics_obj::maxTextureWidth )) {
HXLINE(1906)			_hx_tmp3 = ::hx::IsGreater( width,::openfl::display::Graphics_obj::maxTextureWidth );
            		}
            		else {
HXLINE(1906)			_hx_tmp3 = false;
            		}
HXDLIN(1906)		if (_hx_tmp3) {
HXLINE(1908)			width = ( (Float)(::openfl::display::Graphics_obj::maxTextureWidth) );
HXLINE(1909)			scaleX = (( (Float)(::openfl::display::Graphics_obj::maxTextureWidth) ) / this->_hx___bounds->width);
            		}
HXLINE(1912)		bool _hx_tmp4;
HXDLIN(1912)		if (::hx::IsNotNull( ::openfl::display::Graphics_obj::maxTextureWidth )) {
HXLINE(1912)			_hx_tmp4 = ::hx::IsGreater( height,::openfl::display::Graphics_obj::maxTextureHeight );
            		}
            		else {
HXLINE(1912)			_hx_tmp4 = false;
            		}
HXDLIN(1912)		if (_hx_tmp4) {
HXLINE(1914)			height = ( (Float)(::openfl::display::Graphics_obj::maxTextureHeight) );
HXLINE(1915)			scaleY = (( (Float)(::openfl::display::Graphics_obj::maxTextureHeight) ) / this->_hx___bounds->height);
            		}
HXLINE(1918)		this->_hx___renderTransform->a = (width / this->_hx___bounds->width);
HXLINE(1919)		this->_hx___renderTransform->d = (height / this->_hx___bounds->height);
HXLINE(1920)		Float inverseA = (( (Float)(1) ) / this->_hx___renderTransform->a);
HXLINE(1921)		Float inverseD = (( (Float)(1) ) / this->_hx___renderTransform->d);
HXLINE(1924)		this->_hx___worldTransform->a = (inverseA * parentTransform->a);
HXLINE(1925)		this->_hx___worldTransform->b = (inverseA * parentTransform->b);
HXLINE(1926)		this->_hx___worldTransform->c = (inverseD * parentTransform->c);
HXLINE(1927)		this->_hx___worldTransform->d = (inverseD * parentTransform->d);
HXLINE(1929)		Float x = this->_hx___bounds->x;
HXLINE(1930)		Float y = this->_hx___bounds->y;
HXLINE(1931)		Float tx = (((x * parentTransform->a) + (y * parentTransform->c)) + parentTransform->tx);
HXLINE(1932)		Float ty = (((x * parentTransform->b) + (y * parentTransform->d)) + parentTransform->ty);
HXLINE(1935)		this->_hx___worldTransform->tx = ::Math_obj::fround(tx);
HXLINE(1936)		this->_hx___worldTransform->ty = ::Math_obj::fround(ty);
HXLINE(1939)		 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN(1939)		Float norm = ((_this->a * _this->d) - (_this->b * _this->c));
HXDLIN(1939)		Float _hx_tmp5;
HXDLIN(1939)		if ((norm == 0)) {
HXLINE(1939)			_hx_tmp5 = -(_this->tx);
            		}
            		else {
HXLINE(1939)			_hx_tmp5 = ((((Float)1.0) / norm) * ((_this->c * (_this->ty - ty)) + (_this->d * (tx - _this->tx))));
            		}
HXDLIN(1939)		this->_hx___renderTransform->tx = _hx_tmp5;
HXLINE(1940)		 ::openfl::geom::Matrix _this1 = this->_hx___worldTransform;
HXDLIN(1940)		Float norm1 = ((_this1->a * _this1->d) - (_this1->b * _this1->c));
HXDLIN(1940)		Float _hx_tmp6;
HXDLIN(1940)		if ((norm1 == 0)) {
HXLINE(1940)			_hx_tmp6 = -(_this1->ty);
            		}
            		else {
HXLINE(1940)			_hx_tmp6 = ((((Float)1.0) / norm1) * ((_this1->a * (ty - _this1->ty)) + (_this1->b * (_this1->tx - tx))));
            		}
HXDLIN(1940)		this->_hx___renderTransform->ty = _hx_tmp6;
HXLINE(1946)		int newWidth = ::Math_obj::ceil((width + ((Float)1.0)));
HXLINE(1947)		int newHeight = ::Math_obj::ceil((height + ((Float)1.0)));
HXLINE(1950)		bool _hx_tmp7;
HXDLIN(1950)		if ((newWidth == this->_hx___width)) {
HXLINE(1950)			_hx_tmp7 = (newHeight != this->_hx___height);
            		}
            		else {
HXLINE(1950)			_hx_tmp7 = true;
            		}
HXDLIN(1950)		if (_hx_tmp7) {
HXLINE(1953)			this->set___dirty(true);
            		}
HXLINE(1957)		this->_hx___width = newWidth;
HXLINE(1958)		this->_hx___height = newHeight;
            	}
...
bool Graphics_obj::set___dirty(bool value){
            	HX_STACKFRAME(&_hx_pos_043516e11ce5c7d5_1963_set___dirty)
HXLINE(1964)		bool _hx_tmp;
HXDLIN(1964)		if (value) {
HXLINE(1964)			_hx_tmp = ::hx::IsNotNull( this->_hx___owner );
            		}
            		else {
HXLINE(1964)			_hx_tmp = false;
            		}
HXDLIN(1964)		if (_hx_tmp) {
HXLINE(1966)			 ::openfl::display::DisplayObject _this = this->_hx___owner;
HXDLIN(1966)			if (!(_this->_hx___renderDirty)) {
HXLINE(1966)				_this->_hx___renderDirty = true;
HXDLIN(1966)				_this->_hx___setParentRenderDirty();
            			}
            		}
HXLINE(1969)		if (value) {
HXLINE(1971)			this->_hx___softwareDirty = true;
HXLINE(1972)			this->_hx___hardwareDirty = true;
            		}
HXLINE(1975)		return (this->_hx___dirty = value);
            	}
